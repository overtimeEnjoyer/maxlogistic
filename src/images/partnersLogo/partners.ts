...
export const Partnerslogos = [
    { logo: PartnersPrestigeExpress, alt: "Partners Prestige Express" },
    { logo: PartnersZahidResurs, alt: "Partners Zahid Resurs" },
    { logo: PartnersIndustrialPark, alt: "Partners Industrial Park" },
    { logo: PartnersGreenHouse, alt: "Partners Green House" },
    { logo: PartnersGreenTree, alt: "Partners Green Tree" },
  ];
